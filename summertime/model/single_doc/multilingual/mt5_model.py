...
class MT5Model(MultilingualSummModel):
    ...
    lang_tag_dict = {
        ...
        "mr": "mr", "np": "np",
        "om": "om", "ps": "ps",
        "fa": "fa", "pt": "pt", # missing pidgin from XLSum--does not have ISO 639-1 code
        "pa": "pa", "ru": "ru",
        "gd": "gd", "sr": "sr",
        "si": "si", "so": "so",
        "es": "es", "sw": "sw",
    ...
    def summarize(self, corpus, queries=None):
        ...
        with self.tokenizer.as_target_tokenizer():
            batch = self.tokenizer(corpus, truncation=True, padding="longest", max_length=self.max_input_length, return_tensors="pt").to(self.device)
        
        encoded_summaries = self.model.generate(**batch, num_beams=4, length_penalty=1.0, early_stopping=True)
